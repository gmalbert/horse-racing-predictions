"""
Pull Tier 1 Harness track data directly from track websites.

No USTA API dependency initially; script visits official Harness track sites with Playwright,
tries common entries/results URLs, captures raw HTML/text snapshots, and
extracts race-like sections from page text.

Outputs:
- data/raw/us_t1_h/tracksite/<track_code>_<date>.json
- data/raw/us_t1_h/tracksite/html/<track_code>_<date>.html
- data/raw/us_t1_h/t1_h_tracksite_pull_report_<date>.json

Usage:
    python scripts/pull_t1_h_tracks.py --date 2026-05-09
"""
...
OUT_DIR = PROJECT_ROOT / "data" / "raw" / "us_t1_h"
...
TRACKS = {
    "NTH": {
        ...
        "base": "https://www.northfieldpark.com",
        "paths": [
            "/racing/entries",
    ...
    "SCD": {
        "name": "Scioto Downs",
        "base": "https://www.sciotodowns.com",
        "paths": [
            "/racing/entries",
            "/racing/entries-results",
            "/racing",
    ...
    "RUN": {
        "name": "Running Aces",
        "base": "https://www.runningacesharness.com",
        "paths": [
            "/racing/entries",
            "/racing/entries-results",
            "/racing",
    ...
    "PLN": {
        "name": "Plainridge Park",
        "base": "https://www.plainridgepark.com",
        "paths": [
            "/racing/entries",
            "/racing/entries-results",
            "/racing",
...
async def main(date_str: str):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            report_path = OUT_DIR / f"t1_h_tracksite_pull_report_{date_str}.json"
